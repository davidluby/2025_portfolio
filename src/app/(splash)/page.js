  ...
  return (
    <div className='flex flex-col items-center'>
      ...
      <div className='w-full h-screen overflow-hidden relative'>
        <picture>
          <source media="(max-width: 768px)" srcSet="/keys.jpg" />
          <source media="(min-width: 769px)" srcSet="/golf.jpg" />
          <Image src='/golf.JPG' className='brightness-65' alt='Golf Background' fill={true} />
        </picture>
        <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center space-y-10'>
          <p className='inline text-white font-bold text-5xl text-center'>Thanks for stopping by.</p>
          <Link href='https://www.linkedin.com/in/david-luby/' rel="noopener noreferrer" target="_blank" className='btn bg-[#0967C2] text-white hover:brightness-125 border-none shadow-lg'>
