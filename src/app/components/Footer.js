  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-base-100 text-base-content rounded p-10">
      <nav className="grid grid-flow-row gap-2 md:grid-flow-col md:gap-4">
        ...
        <Link href='fullstack' className='link link-hover'>Fullstack Application</Link>
        <Link href='mechatronics' className='link link-hover'>Mechatronics</Link>
        <Link href='3d-fluid' className='link link-hover'>3D Fluid Simulation</Link>
        <Link href='2d-fluid' className='link link-hover'>2D Fluid Simulation</Link>
        <Link href='collision' className='link link-hover'>Collision Simulation</Link>
        <Link href='iterative' className='link link-hover'>Iterative Methods</Link>
        <Link href='webgl' className='link link-hover'>WebGL</Link>
        <Link href='papers' className='link link-hover'>Papers</Link>
      </nav>
      <nav>
