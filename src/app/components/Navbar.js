...
const Navbar = () => {
  return (
    <div className="navbar bg-base-100 shadow-sm">
        ...
        <div className="navbar-end menu menu-horizontal space-x-3">
            <Link href='https://www.linkedin.com/in/david-luby/' rel="noopener noreferrer" target="_blank">
            ...
            <Link href='https://github.com/davidluby' rel="noopener noreferrer" target="_blank">
