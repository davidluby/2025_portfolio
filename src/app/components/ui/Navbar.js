        ...
        <div className="navbar-start h-full">
            ...
            <div className="hidden lg:flex shrink-0 h-full p-0">
                <ul className="menu menu-horizontal px-1 p-0">
                    <li><Link className='rounded-none h-full flex items-center' href='resume'>Resume</Link></li>
                    <li><Link className='rounded-none h-full flex items-center' href='fullstack'>Fullstack Application</Link></li>
                    <li><Link className='rounded-none h-full flex items-center' href='mechatronics'>Mechatronics</Link></li>
                    ...
                    <li><Link className='rounded-none h-full flex items-center' href='papers'>Papers</Link></li>
                </ul>
            </div>
        </div>
