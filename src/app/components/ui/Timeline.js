    ...
    <div>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-end mb-10 md:text-end hover:scale-110 hover:z-10 transition transition-all duration-150 ease-in-out">
        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end hover:scale-110 hover:z-10 transition transition-all duration-300 ease-in-out">
        ...
        <li>
          ...
          <div className="timeline-end mb-10 md:text-end hover:scale-110 hover:z-10 transition transition-all duration-300 ease-in-out">
