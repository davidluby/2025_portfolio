...
const Timeline_Element = ({ content }) => {
  ...
  return (
    <li id={content.title + '-parent'}>
      ...
      <div id={content.title} className="timeline-end md:text-end w-19/20 md:w-full rounded-sm shadow-xl overflow-hidden tansition transition-all duration-750 translate-y-25 opacity-0">
        {
        content.link !== null ?
