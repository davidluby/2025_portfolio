...
const Timeline_Element = ({ content }) => {
  ...
  return (
    <li id={content.title + '-parent'}>
      ...
      <div id={content.title} className="timeline-start relative w-19/20 md:w-full h-50 md:h-100 rounded-sm shadow-xl overflow-hidden tansition transition-all duration-750 translate-y-25 opacity-0">
        {
        content.link !== null ?
